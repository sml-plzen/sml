...
([adsisearcher](
	...
	$userRecord = New-Object Object
	Add-Member -InputObject $userRecord -MemberType NoteProperty -Name distinguishedName -Value $_.distinguishedName.value
	Add-Member -InputObject $userRecord -MemberType NoteProperty -Name homeDirectory -Value $_.homeDirectory.value
	$userRecord
